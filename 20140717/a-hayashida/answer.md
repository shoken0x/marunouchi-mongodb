...
# mongod --replSet rs1 --port 20011 --dbpath /data1/node11 --rest --nojournal
# mongod --replSet rs2 --port 20021 --dbpath /data1/node21 --rest --nojournal
# mongod --replSet rs3 --port 20031 --dbpath /data1/node31 --rest --nojournal
...
# mongod --replSet rs1 --port 20012 --dbpath /data1/node12 --rest --nojournal
# mongod --replSet rs2 --port 20022 --dbpath /data1/node22 --rest --nojournal
# mongod --replSet rs3 --port 20032 --dbpath /data1/node32 --rest --nojournal
...
# mongod --replSet rs1 --port 20013 --dbpath /data1/node13 --rest --nojournal
# mongod --replSet rs2 --port 20023 --dbpath /data1/node23 --rest --nojournal
# mongod --replSet rs3 --port 20033 --dbpath /data1/node33 --rest --nojournal
...
$ sudo su -
# mkdir /data1/config
# mongod --configsvr --port 10001 --dbpath /data1/config --rest
# mongos --configdb %IP%:10001 --port 10000 --chunkSize 1
